========================================================================
    ACTIVEX 控件 DLL : Acom 项目概述
========================================================================

控件向导已为 Acom ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 
控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 Acom ActiveX 控件 DLL 的每个文件的内容。
...
AcomCtrl.h
    此文件包含 CAcomCtrl C++ 类的声明。

AcomCtrl.cpp
    此文件包含 CAcomCtrl C++ 类的实现。

AcomPropPage.h
    此文件包含 CAcomPropPage C++ 类的声明。

AcomPropPage.cpp
    此文件包含 CAcomPropPage C++ 类的实现。

CAcomCtrl.bmp
    此文件包含一个位图，当 CAcomCtrl 
...
stdAfx.h，stdAfx.cpp
    这些文件用于生成名为 Acom.pch 的预编译头 (PCH) 文件和名为 
